/**
 * Inventory/components/ImagePicker.tsx
 *
    ...
    <View style={styles.container}>
      ...
      {value ? (
        <View style={styles.actionsRow}>
          <Pressable onPress={pickImage} hitSlop={6} accessibilityRole="button" accessibilityLabel="Replace image">
            <View style={styles.actionChip}>
              <RefreshCw size={13} color={COLORS.primaryDark} strokeWidth={2.4} />
              <Text style={styles.actionChipText}>Replace</Text>
            </View>
          </Pressable>
          <Pressable onPress={removeImage} hitSlop={6} accessibilityRole="button" accessibilityLabel="Remove image">
